...
#define ALSVINN_MAKE_TIMER_STRINGS5(X,Y, Z,V,W) #X, #Y, #V, #W

// see https://stackoverflow.com/a/11763277 for explanation of GET_MACRO
#define GET_MACRO(_1,_2,_3, _4, _5, NAME,...) NAME
#define ALSVINN_MAKE_TIMER_VARIABLE_NAME(...) GET_MACRO(__VA_ARGS__, ALSVINN_MAKE_TIMER_VARIABLE_NAME5, ALSVINN_MAKE_TIMER_VARIABLE_NAME4, ALSVINN_MAKE_TIMER_VARIABLE_NAME3, ALSVINN_MAKE_TIMER_VARIABLE_NAME2, ALSVINN_MAKE_TIMER_VARIABLE_NAME1)(__VA_ARGS__)
#define ALSVINN_MAKE_TIMER_STRINGS(...) GET_MACRO(__VA_ARGS__, ALSVINN_MAKE_TIMER_STRINGS5, ALSVINN_MAKE_TIMER_STRINGS4,ALSVINN_MAKE_TIMER_STRINGS3, ALSVINN_MAKE_TIMER_STRINGS2, ALSVINN_MAKE_TIMER_STRINGS1)(__VA_ARGS__)
