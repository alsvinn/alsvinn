...
public:
    ...
    /// nothing else.
    ///
    typedef boost::shared_ptr<memory::Memory<real> > ScalarMemoryPtr;

    ///
    /// Const version of the memory pointer
    ///
    typedef boost::shared_ptr<const memory::Memory<real> > ConstScalarMemoryPtr;
    ...
    ///
    EulerPrimitiveVolume(boost::shared_ptr<memory::MemoryFactory> memoryFactory,
