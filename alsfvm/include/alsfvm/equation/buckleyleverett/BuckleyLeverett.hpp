...
public:
    ...
    __device__ __host__ static  ConservedVariables fetchConservedVariables(buckleyleverett::Views<T, S>& views, size_t index)  {
    ...
    __device__ __host__ real computeWaveSpeed(const ConservedVariables& u,
        ...
        return fabs(2*u.u*(u.u*u.u+(1-u.u)*(1-u.u))-u.u*u.u*(2*u.u-2*(1-u.u)))
    ...
    __device__ __host__ rvec1 computeEigenValues(const ConservedVariables& u) const {
        return  (2*u.u*(u.u*u.u+(1-u.u)*(1-u.u))-u.u*u.u*(2*u.u-2*(1-u.u)))
                / ((u.u*u.u+(1-u.u)*(1-u.u))*(u.u*u.u+(1-u.u)*(1-u.u)));
    }
