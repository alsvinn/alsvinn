...
public:
    ...
    typedef equation::burgers::Views<const volume::Volume, const memory::View<const real> >
    ConstViews;

    typedef equation::burgers::ViewsExtra<volume::Volume, memory::View<real> >
    ViewsExtra;
    typedef equation::burgers::ViewsExtra<const volume::Volume, const memory::View<const real> >
    ConstViewsExtra;
    ...
    __device__ __host__ static  ConservedVariables fetchConservedVariables(
        burgers::Views<T, S>& views, size_t index)  {
