...
///
template<int nsd>
__device__ __host__ inline ConservedVariables<nsd> operator-
(const ConservedVariables<nsd>& a, const ConservedVariables<nsd>& b) {
...
////
template<int nsd>
__device__ __host__ inline ConservedVariables<nsd> operator*(real a,
...
template<int nsd>
__device__ __host__ inline ConservedVariables<nsd> operator/
(const ConservedVariables<nsd>& a, real b) {
    return ConservedVariables<nsd>(a.rho / b, a.m / b, a.E / b);
}

template<>
__device__ __host__ inline ConservedVariables<3>::ConservedVariables(
    const rvec5& in)
...
template<>
__device__ __host__ inline ConservedVariables<2>::ConservedVariables(
    const rvec4& in)
...
template<>
__device__ __host__ inline ConservedVariables<1>::ConservedVariables(
    const rvec3& in)
