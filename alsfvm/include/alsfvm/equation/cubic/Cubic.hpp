...
public:
    ...
    typedef equation::cubic::Views<const volume::Volume, const memory::View<const real> > ConstViews;

    typedef equation::cubic::ViewsExtra<volume::Volume, memory::View<real> > ViewsExtra;
    typedef equation::cubic::ViewsExtra<const volume::Volume, const memory::View<const real> > ConstViewsExtra;
    ...
    __device__ __host__ static  ConservedVariables fetchConservedVariables(cubic::Views<T, S>& views, size_t index)  {
