...
namespace alsfvm {
    ...
    struct vec6 {
        ...
        __device__ __host__ bool operator==(const vec6& other) const {
            return other.x == x && other.y == y && other.z == z && other.v == v && other.w == w&& other.u == u;
        }
        ...
        __device__ __host__ T dot(const vec6<T>& other) const {
            return x*other.x + y*other.y + z*other.z + v*other.v + w*other.w + u * other.u;
        }
    ...
    ///
    template<class T>
    __device__ __host__ inline vec6<T> operator/(const vec6<T>& a, const vec6<T>& b) {
    ...
    __device__ __host__ inline vec6<T> operator*(T scalar, const vec6<T>& a) {
        return vec6<T>(a.x*scalar, a.y*scalar, a.z*scalar, a.v*scalar, a.w*scalar, a.u * scalar);
    }
