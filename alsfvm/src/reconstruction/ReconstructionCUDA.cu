...
__global__ void reconstructDevice(Equation eq,
    typename Equation::ConstViews input,
    ...
    const size_t x = xInternalFormat + (ReconstructionType::getNumberOfGhostCells()
            - 1) + start.x;
    const size_t y = yInternalFormat + (dimension > 1) *
        (ReconstructionType::getNumberOfGhostCells() - 1) + start.y;
    const size_t z = zInternalFormat + (dimension > 2) *
        (ReconstructionType::getNumberOfGhostCells() - 1) + start.z;

    ReconstructionType::reconstruct(eq, input, x, y, z, left, right, xDir, yDir,
        zDir);
...
template<class Equation, class ReconstructionType, size_t dimension, bool xDir, bool yDir, bool zDir >
void callReconstructionDevice(const Equation& equation,
    ...
    const int numberOfXCells = int(leftOut.getTotalNumberOfXCells()) - 2 *
        (ReconstructionType::getNumberOfGhostCells() - 1) - start.x + end.x;
    const int numberOfYCells = int(leftOut.getTotalNumberOfYCells()) - 2 *
        (dimension > 1) * (ReconstructionType::getNumberOfGhostCells() - 1) - start.y +
        end.y;
    const int numberOfZCells = int(leftOut.getTotalNumberOfZCells()) - 2 *
        (dimension > 2) * (ReconstructionType::getNumberOfGhostCells() - 1) - start.z +
        end.z;
    ...
    reconstructDevice<Equation, ReconstructionType, dimension, xDir, yDir, zDir>
            << <gridSize, blockSize >> >(equation, viewInput,
                    viewLeft, viewRight,
                    numberOfXCells,
                    numberOfYCells,
                    numberOfZCells,
...
void performReconstructionDevice(const Equation& equation,
    const volume::Volume& inputVariables,
    size_t direction,
    size_t indicatorVariable,
    volume::Volume& leftOut,
    ...
    switch (direction) {
    case 0:
        callReconstructionDevice<Equation, ReconstructionType, dimension, 1, 0, 0>
        (equation,
            inputVariables,
            direction,
            indicatorVariable,
    ...
    case 1:
        callReconstructionDevice<Equation, ReconstructionType, dimension, 0, 1, 0>
        (equation,
            inputVariables,
            direction,
            indicatorVariable,
    ...
    case 2:
        callReconstructionDevice<Equation, ReconstructionType, dimension, 0, 0, 1>
        (equation,
            inputVariables,
            direction,
            indicatorVariable,
...
void ReconstructionCUDA<ReconstructionType, Equation>::performReconstruction(
    const volume::Volume& inputVariables,
    size_t direction,
    size_t indicatorVariable,
    volume::Volume& leftOut,
...
template class ReconstructionCUDA
< WENOF2<equation::euler::Euler<1> >, equation::euler::Euler<1> >;
template class ReconstructionCUDA
<  WENO2<equation::euler::Euler<1> >, equation::euler::Euler<1> >;
template class ReconstructionCUDA
<  MC<equation::euler::Euler<1> >, equation::euler::Euler<1> >;
template class ReconstructionCUDA
<  MM<equation::euler::Euler<1> >, equation::euler::Euler<1> >;


template class ReconstructionCUDA
< WENOF2<equation::euler::Euler<2> >, equation::euler::Euler<2> >;
template class ReconstructionCUDA
<  WENO2<equation::euler::Euler<2> >, equation::euler::Euler<2> >;
template class ReconstructionCUDA
<  MC<equation::euler::Euler<2> >, equation::euler::Euler<2> >;
template class ReconstructionCUDA
<  MM<equation::euler::Euler<2> >, equation::euler::Euler<2> >;

template class ReconstructionCUDA
< WENOF2<equation::euler::Euler<3> >, equation::euler::Euler<3> >;
template class ReconstructionCUDA
<  WENO2<equation::euler::Euler<3> >, equation::euler::Euler<3> >;
template class ReconstructionCUDA
<  MC<equation::euler::Euler<3> >, equation::euler::Euler<3> >;
template class ReconstructionCUDA
<  MM<equation::euler::Euler<3> >, equation::euler::Euler<3> >;

template class ReconstructionCUDA
< WENO2<equation::burgers::Burgers>, equation::burgers::Burgers>;
template class ReconstructionCUDA
< MC<equation::burgers::Burgers>, equation::burgers::Burgers>;
template class ReconstructionCUDA
< MM<equation::burgers::Burgers>, equation::burgers::Burgers>;
}
}
