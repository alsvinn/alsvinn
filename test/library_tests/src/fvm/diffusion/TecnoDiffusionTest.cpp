...
INSTANTIATE_TEST_CASE_P(TecnoDiffusionTestsTecnoeRoe,
    TecnoDiffusionTest,
    ::testing::Values(
        DiffusionParameters("cpu", "burgers", "tecnoroe", "none", 1.),
        DiffusionParameters("cpu", "burgers", "tecnoroe", "eno2", 2.),
        DiffusionParameters("cpu", "burgers", "tecnoroe", "eno3", 3.),
        DiffusionParameters("cpu", "burgers", "tecnoroe", "eno4", 3.),
        DiffusionParameters("cuda", "burgers", "tecnoroe", "none", 1.),
