...
void StructureTwoPoints::computeStatistics(const alsfvm::volume::Volume &conservedVariables,
                ...
                for(int i = 0; i < nx; ++i) {
                    ...
                    for(int h1 = 0; h1 < int(numberOfH); ++h1) {
                        ...
                        for (int h2 = 0; h2 < int(numberOfH); ++h2) {
                            ...
                            outputView.at(h1,h2,0) += (u_ijk_h1-u_ijk)*(u_ijk_h1-u_ijk)*(u_ijk_h2-u_ijk)/(nx*ny*nz);
                        }
                    }
                }
            }
