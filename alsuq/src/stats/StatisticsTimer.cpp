...
void StatisticsTimer::combineStatistics()
{
    ...
    combineTime += std::chrono::duration_cast<std::chrono::seconds>(endTime - startTime).count();

}

void StatisticsTimer::addWriter(const std::string &name, std::shared_ptr<alsfvm::io::Writer> &writer)
{
...
void StatisticsTimer::computeStatistics(const alsfvm::volume::Volume &conservedVariables,
                                        ...
                                        const alsfvm::simulator::TimestepInformation &timestepInformation)
{
    ...
    statisticsTime += std::chrono::duration_cast<std::chrono::seconds>(endTime - startTime).count();
...
void StatisticsTimer::finalize()
{
    ...
    finalizeTime += std::chrono::duration_cast<std::chrono::seconds>(endTime - startTime).count();
}
