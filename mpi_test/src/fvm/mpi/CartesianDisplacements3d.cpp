...
TEST(CartesianDisplacements, Displacements3DWithOffset) {
    const int N = 1024;
    const int ghostCells = 3;
    auto displacementsLeft = computeDisplacements(0, 3, {N,N,N}, ghostCells, ghostCells);
    ASSERT_EQ(N*N, displacementsLeft.size());
    ...
    auto displacementsRight = computeDisplacements(1, 3, {N,N,N}, ghostCells, ghostCells);
    ASSERT_EQ(N*N, displacementsRight.size());
    ...
    auto displacementsBottom = computeDisplacements(2, 3, {N,N,N}, ghostCells, ghostCells);
    ASSERT_EQ(N, displacementsBottom.size());
    ...
    auto displacementsTop = computeDisplacements(3, 3, {N,N,N}, ghostCells, ghostCells);
    ASSERT_EQ(N, displacementsTop.size());
    ...
    auto displacementsFront = computeDisplacements(4, 3, {N,N,N}, ghostCells, ghostCells);
    ASSERT_EQ(1, displacementsFront.size());
    ASSERT_EQ(ghostCells*N*N, displacementsFront[0]);



    auto displacementsBack = computeDisplacements(5, 3, {N,N,N}, ghostCells, ghostCells);
    ASSERT_EQ(1, displacementsBack.size());
